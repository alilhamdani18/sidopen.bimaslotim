...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3 fw-bold text-warning fs-3" href="index.html">SIMBAH</a>
    <!-- Sidebar Toggle-->
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container px-4">
          <h1 class="mt-4 fw-semibold">Tambah Data Keluar</h1>
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Tambah Data Keluar</li>
          </ol>
          <div class="card mb-4">
            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $ambilDataKeluar = mysqli_query($conn, "SELECT * FROM tbl_keluar");
                  $No = 1;
                  ...
                  ?>
                    ...
                    <!-- readData -->
                    <div class="modal fade" id="readData<?= $id_keluar; ?>">
                    ...
                    <!-- Edit Data  -->
                    <div class="modal fade" id="editData<?= $id_keluar; ?>">
                      <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content p-3">
                          <div class="modal-header py-2">
                            ...
                            <form action="" method="POST">
                              <div class="inputfield">
                                ...
                                <div>
                                  ...
                                  <input type="number" name="banyak_keluar" value="<?= $banyak_keluar; ?>" id="jmlKeluar" />
                                </div>
                                <div class="row">
                                  <div class="col-lg-6">
                                    <label for="model">Model</label>
                              ...
                              <div class="d-flex justify-content-center my-3">
                                <button type="submit" class="btn btn-primary submit" name="editKeluar">Edit Data</button>
                              </div>
                            </form>
                          </div>
                        </div>
                    ...
                    <!-- Hapus Data  -->
                    <div class="modal fade" id="hapusData<?= $id_keluar; ?>">
                      <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content p-3">
                          <div class="modal-header py-2">
                            <h4 class="modal-title fw-bold">Hapus Data Keluar</h4>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <form action="" method="POST">
                              ...
                              <input type="hidden" name="id_keluar" value="<?= $id_keluar; ?>">
                              <div class="d-flex justify-content-center my-3">
                                <button type="submit" class="btn btn-danger submit" name="hapusDataKeluar">Hapus</button>
                              </div>
                            </form>
                          </div>
                        </div>
      ...
      <div class="modal fade" id="formTambahDataMasuk">
        <div class="modal-dialog modal-dialog-centered modal-lg bg-secondary">
          <div class="modal-content p-3">
            <div class="modal-header py-2">
              <h4 class="modal-title fw-bold">Tambah Data Keluar</h4>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer d-flex justify-content-center">
              <button type="submit" form="formKeluar" class="btn btn-primary submit" name="addDataKeluar" value="addDataKeluar">Tambah Data</button>
            </div>
          </div>
        </div>
      </div>
