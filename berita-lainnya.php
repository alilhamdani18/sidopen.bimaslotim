  ...
  <div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container px-4">
          <h1 class="mt-4 fw-semibold">Tambah Berita Acara Kerusakan Barang</h1>
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
            <li class="breadcrumb-item active">Berita Acara Kerusakan Barang</li>
          </ol>
          <div class="card mb-4">
            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $ambilData = mysqli_query($conn, "SELECT * FROM tbl_berita_lainnya");
                  $No = 1;
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <!-- <td><?= $berkas; ?></td> -->
                      <td>
                        <button class="btn btn-success action m-1" data-bs-toggle="modal" data-bs-target="#readData<?= $id_berkas; ?>"><i class="fa-solid fa-download"></i></button>
                        <!-- <button class="btn btn-primary action my-1" data-bs-toggle="modal" data-bs-target="#editData<?= $id_berkas; ?>"><i class="fa-solid fa-pen-to-square"></i></button> -->
                        <button class="btn btn-danger action" data-bs-toggle="modal" data-bs-target="#hapusData<?= $id_berkas; ?>"><i class="fa-solid fa-trash-can"></i></button>
                      </td>
                    </tr>
                    <!-- Download Data -->
                    <div class="modal fade" id="readData<?= $id_berkas; ?>">
                    ...
                    <!-- Edit Data  -->
                    <div class="modal fade" id="editData<?= $id_berkas; ?>">
                    ...
                    <!-- Hapus Data  -->
                    <div class="modal fade" id="hapusData<?= $id_berkas; ?>">
                      <div class="modal-dialog modal-dialog-centered modal-md">
                        <div class="modal-content p-3">
                          <div class="modal-header py-2">
                          ...
                          <div class="modal-body">
                            <form action="" method="post">
                              ...
                              <div class="d-flex justify-content-center mt-5">
                                ...
                                <button type="submit" class="btn btn-danger submit" name="hapusBeritaKeluar">Hapus</button>
                              </div>
                            </form>
                          </div>
                        </div>
    ...
    <div class="modal fade" id="uploadFile">
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content p-3">
          <div class="modal-header py-2">
            <h4 class="modal-title fw-bold">Tambah Berita Acara</h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="inputfield">
                ...
                <div class="modal-footer d-flex justify-content-center">
                  <button type="submit" class="btn btn-primary" name="beritaKeluar" value="Tambah Data">Tambah Data</button>
                </div>
              </div>
            </form>
          </div>
