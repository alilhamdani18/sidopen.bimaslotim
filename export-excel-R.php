...
if (isset($_POST['export_excel'])) {
  ...
  if($tanggal_awal && $tanggal_akhir != null) {
    $sql = "SELECT * FROM tbl_masuk WHERE model = 'R' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    $sql2 = "SELECT * FROM tbl_keluar WHERE model = 'R' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    $sql3 = "SELECT * FROM tbl_lainnya WHERE model = 'R' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    
  } else {
    $sql = "SELECT * FROM tbl_masuk WHERE model = 'R'";
    $sql2 = "SELECT * FROM tbl_keluar WHERE model = 'R'";
    $sql3 = "SELECT * FROM tbl_lainnya WHERE model = 'R'";
...
?>
  <h1 style="text-align:center;vertical-align:middle;text-decoration:underline;">REKAPITULASI DATA PENDISTRIBUSIAN BUKU NIKAH MODEL R</h1>
<?php
