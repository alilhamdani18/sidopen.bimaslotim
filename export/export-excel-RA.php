...
?>
  <h1 style="text-align:center;vertical-align:middle;text-decoration:underline;background-color:salmon;">REKAPITULASI DATA PENDISTRIBUSIAN BUKU NIKAH MODEL RA TAHUN <?= $tahun; ?></h1>
<?php
  ...
  ';
   ...
   ';
    ...
    header('location:../report/laporan-model-RA.php');
  }
