...
?>
  <h1 style="text-align:center;vertical-align:middle;text-decoration:underline;background-color:salmon;">REKAPITULASI DATA PENDISTRIBUSIAN BUKU NIKAH MODEL NB TAHUN <?= $tahun; ?></h1>
<?php

  if (mysqli_num_rows($result) > 0) {
    $output1 .= '
    <h2 style="margin:1rem 0;text-align:center;">Laporan Masuk Model NB</h2>
  ...
  if (mysqli_num_rows($result2) > 0) {
    $output2 .= '
    <h2 style="margin:1rem 0;text-align:center;">Laporan Keluar Model NB</h2>
    <table class="table table-bordered" border="1"> 
      <thead class="table-dark">
        <tr>
          <th rowspan="2">No.</th>
