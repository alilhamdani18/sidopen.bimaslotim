...
?>
  <h1 style="text-align:center;vertical-align:middle;text-decoration:underline;background-color:salmon;">REKAPITULASI DATA PENDISTRIBUSIAN BUKU NIKAH MODEL R TAHUN <?= $tahun; ?></h1>
<?php
