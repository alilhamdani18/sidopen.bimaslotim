      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <div class="btn-group mb-4">
            ...
            <form action="export-excel-N.php" method="post" class="col d-flex">
          ...
          <div class="card mb-4">
            <div class="card-header d-flex justify-content-between">
              <div>
                <h4 class="fw-semibold">Laporan Kerusakan Barang Model N</h4>
              </div>
            </div>
            <div class="card-body table-responsive ">
              <table id="" class="display" style="width:100%">
                ...
                <tbody>
                  <?php
                  $ambilDataKeluar = mysqli_query($conn, "SELECT * FROM tbl_lainnya WHERE model = 'N'");
                  $No = 1;
                  while ($data = mysqli_fetch_array($ambilDataKeluar)) {
