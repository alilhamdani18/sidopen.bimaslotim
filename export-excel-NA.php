...
if (isset($_POST['export_excel'])) {
  ...
  if($tanggal_awal && $tanggal_akhir != null) {
    $sql = "SELECT * FROM tbl_masuk WHERE model = 'NA' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    $sql2 = "SELECT * FROM tbl_keluar WHERE model = 'NA' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    $sql3 = "SELECT * FROM tbl_lainnya WHERE model = 'NA' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'";
    
  } else {
    $sql = "SELECT * FROM tbl_masuk WHERE model = 'NA'";
    $sql2 = "SELECT * FROM tbl_keluar WHERE model = 'NA'";
    $sql3 = "SELECT * FROM tbl_lainnya WHERE model = 'NA'";
...
?>
  <h1 style="text-align:center;vertical-align:middle;text-decoration:underline;">REKAPITULASI DATA PENDISTRIBUSIAN BUKU NIKAH MODEL NA</h1>
<?php
  ...
  if (mysqli_num_rows($result3) > 0) {
    ...
    <h2 style="margin:1rem 0;text-align:center;">Laporan Kerusakan Barang Model NA</h2>
    <table class="table table-bordered" border="1"> 
      <thead class="table-dark">
        <tr>
          <th rowspan="2">No.</th>
